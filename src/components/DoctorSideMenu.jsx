...
const DoctorSideMenu = ({ doctor }) => {
  ...
  return (
    <aside className="w-64 bg-teal-700 text-white flex flex-col h-screen shadow-lg">
      ...
      {/* Optional footer / version or logout hint */}
